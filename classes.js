...
class Player{
 ...
 // this functions gives a random number from 1 to 9          
 GetRondNo(){
...
// this function sets up the players!
    function initGame(){
        player1.start();
        player2.start();
        status();
    }
 //this functions starts the battle it makes the players fight each other!
    function startGame(){
        player1.Battle(player1,player2);
        status();
    }
 //it shows the status of each player!
    function status(){
